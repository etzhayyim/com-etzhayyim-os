...
(defn collection
  [name]
  (str "com.etzhayyim.os." name))

(def cell-specs {
  :get {:legacy-cell "com-etzhayyim-apps-os-coverage-get"
     :phase :event
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :agent {:legacy-cell "com-etzhayyim-apps-os-agent"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "agent")]
     :required-gates common-gates
     :trigger "manifest cell agent"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :consentrequest {:legacy-cell "com-etzhayyim-apps-os-consentRequest"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "consentrequest")]
     :required-gates common-gates
     :trigger "manifest cell consentrequest"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :budgetallocation {:legacy-cell "com-etzhayyim-apps-os-budgetAllocation"
     :phase :event
     :murakumo-node "reuben"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :directoryentry {:legacy-cell "com-etzhayyim-apps-os-directoryEntry"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "directoryentry")]
     :required-gates common-gates
     :trigger "manifest cell directoryentry"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
